...
converse_cyclicOrdering(disjoint,disjoint_inv).
...
converse_cyclicOrdering(disjoint_inv,disjoint).
...
%%meets_between_intervals 
sm_cyclicOrdering(meets, StIn1, StIn2, Jun) :-
     object(Jun, type(junction)),
     object(StIn1, type(street_interval)),
     object(StIn2, type(street_interval)), %get objects which have type street_interval
     StIn1 \= StIn2,
     relation(part_of, St, StIn1),
     object(St, type(street)),
     relation(part_of, St, StIn2).

%disjoints_intervals	 
sm_cyclicOrdering(disjoint, StIn1, StIn2, Jun) :-
     object(Jun, type(junction)),
     object(StIn1, type(street_interval)),
     object(StIn2, type(street_interval)), %get objects which have type street_interval
     StIn1 \= StIn2,
